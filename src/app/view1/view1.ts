...
export default class View1 extends LitElement {
  ...
  constructor() {
    ...
    this.financialBoxOfficeRevenue = this.financialService.getData('BoxOfficeRevenueType');
  }
        ...
        <div class="row-layout group_1">
          <igc-card class="card">
            <igc-card-media class="media-content">
              <img src="https://images.unsplash.com/photo-1503259901638-6bf44a4cd670?ixid=MnwxMjA3fDB8MHxzZWFyY2h8ODR8fGNvbG9yZnVsJTIwYWJzdHJhY3QlMjBiYWNrZ3JvdW5kfGVufDB8fDB8fA%3D%3D&amp;ixlib=rb-1.2.1&amp;auto=format&amp;fit=crop&amp;w=500&amp;q=60" attr="" class="image" />
            </igc-card-media>
            <igc-card-header>
              <h3 slot="title">
                Title goes here...
          ...
          <igc-tree selection="none" class="tree">
            ...
            <igc-tree-item label="Development">
              ...
              <igc-tree-item label="Web components"></igc-tree-item>
            </igc-tree-item>
          </igc-tree>
          <div class="column-layout group_3">
            <div class="row-layout group_4">
              ...
              <igc-button variant="fab" class="user-input">
                <span class="material-icons">
                  add
                </span>
                <igc-ripple></igc-ripple>
            ...
            <span class="user-input_1">ButtonGroup not yet available in WebComponents</span>
            ...
            <igc-rating size="large" class="user-input"></igc-rating>
          ...
          <div class="column-layout group_6">
            <igc-combo ?outlined="${true}" .data="${this.financialBoxOfficeRevenue}" label="Label/Placeholder" value-key="Franchise" display-key="Franchise" ?autoFocusSearch="${true}" class="user-input_1"></igc-combo>
            <span class="date-picker">DatePicker not yet available in WebComponents</span>
            <igc-input label="Label/Placeholder" ?outlined="${true}" class="user-input_1"></igc-input>
            <igc-select ?outlined="${true}" label="Label/Placeholder" class="user-input_1">
        ...
        <div class="row-layout group_7">
          <igc-tabs class="tabs">
            ...
            <igc-tab-panel class="row-layout tab-item-content">
              <img src="https://images.unsplash.com/photo-1503259901638-6bf44a4cd670?ixid=MnwxMjA3fDB8MHxzZWFyY2h8ODR8fGNvbG9yZnVsJTIwYWJzdHJhY3QlMjBiYWNrZ3JvdW5kfGVufDB8fDB8fA%3D%3D&amp;ixlib=rb-1.2.1&amp;auto=format&amp;fit=crop&amp;w=500&amp;q=60" attr="" class="image_1" />
            </igc-tab-panel>
            <igc-tab>
              <span class="material-icons">info</span>
              Label
